/**
 * LeoEventObserver 1.0 - built on  July 02, 2021
 */
...
"conversion"===c?f=PREFIX_EVENT_CONVERSION_URL:"feedback"===c&&(f=PREFIX_EVENT_FEEDBACK_URL,g=!0);c="";g?(c=f+"?ctxsk="+k,LeoCorsRequest.post(!1,c,[],a,d)):(c=f+"?"+a+"&ctxsk="+k,LeoCorsRequest.get(!1,c,[],d));console.log("LeoCorsRequest url "+c)}else console.log("sessionKey is NULL")};e.getContextSession=function(c){if("string"!==typeof u()){c=r(c);var a=l();LeoCorsRequest.get(!1,PREFIX_SESSION_INIT_URL+"?"+c+"&visid="+a,[],function(d,k){var g=JSON.parse(k);if(101===g.status){m=g.sessionKey;lscache.set(leoSessionStringKey,
m,SESSION_CACHE_MINUTES);var f=l(),n=g.visitorId;n&&n!==f&&lscache.set(leoVisitorIdStringKey,n);sendMessage("LeoObserverProxyReady");window.console&&window.console.log(g)}else console.error(g)})}else sendMessage("LeoObserverProxyReady")};e.updateProfile=function(c){c.visid=l();c=r(c);var a=u();LeoCorsRequest.post(!1,PREFIX_UPDATE_PROFILE_URL+"?ctxsk="+a,[],c,function(d,k){})};e.initFingerprint=function(c){Fingerprint2.get({excludes:{enumerateDevices:!0,deviceMemory:!0}},function(a){a=a.map(function(d){return d.value});
a=Fingerprint2.x64hash128(a.join(""),31);lscache.set("leocdp_fgp",a);e.fingerprintId=a;"function"===typeof c&&c(a)})};e.getVisitorId=l;q.LeoEventObserver=e})("undefined"===typeof window?this:window);